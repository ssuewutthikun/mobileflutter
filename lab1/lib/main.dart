...
void main() {
  ...
  */
  ...
  print(xy_result);
    ...
    //// โจทย์ฝึกปฏิบัติ
    /**
   * ให้นักศึกษาประกาศตัวแปร 
   * ชนิด String  เพื่อเก็บชื่อนักศึกษา
   * ชนิด String  เพื่อเก็บชื่อนามสกุล
   * ชนิด double เพื่อเก็บเกรดเฉลี่ยนปัจจุบัน
   * ชนิด int เพื่อเก็บปี พศ เกิด
   * และแสดงผลลัพธ์ออกทางหน้าจอดังนี้
   * 
   * ชือนักศึกษา นาย ศราวุธ ซือวุฒิกุล
   * เกรดเฉลี่ยรวมปัจจุบัน 3.75
   * อายุ 39 ปี
   * 
   */
